...
class AyudaCommand extends UserCommand
{
     ...
     * @var string
     */
    protected $description = 'Muestra los comandos de ayuda';
    ...
    public function execute(): ServerResponse
    {
        ...
        if ($command_str === '') {
            $text = '*Lista de Opciones*:' . PHP_EOL;
            ...
            $text .= PHP_EOL . 'Para ayuda concreta: /ayuda <comando>';
        ...
        return $this->replyToChat('No hay ayuda disponible: Comando `/' . $command_str . '` no encontrado', ['parse_mode' => 'markdown']);
    }
