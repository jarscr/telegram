...
class EncuestaCommand extends UserCommand
{
    /**
     * @var string
     */
    protected $name = 'encuesta';

    /**
     * @var string
     */
    protected $description = 'Encuesta del Bot';

    /**
     * @var string
     */
    protected $usage = '/encuesta';
        ...
        switch ($state) {
            ...
            case 1:
                if ($text === '' || !is_numeric($text)) {
                    ...
                    $data['text'] = 'Escriba su Edad:';
                    if ($text !== '') {
                        $data['text'] = 'Ingrese el número';
                    }
            ...
            // No break!
            case 2:
                if ($text === '' || !in_array($text, ['H', 'F','O'], true)) {
                    $notes['state'] = 3;
                    $this->conversation->update();

                    $data['reply_markup'] = (new Keyboard(['H', 'F','O']))
                        ->setResizeKeyboard(true)
                        ->setOneTimeKeyboard(true)
                        ->setSelective(true);

                    $data['text'] = 'Selecione su Genero:';
                    if ($text !== '') {
                        $data['text'] = 'Por favor use el teclado para seleccionar su Genero';
                    }
